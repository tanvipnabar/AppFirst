 ...
 * 
 * <p>
 * Each Alert History object should have the following field.
 * <br> id (read-only)	Unique id for the application in our system
 * <br> start (read-only)	The start time of this alert history incident
 * <br> end (read-only)	The end time of this alert history incident, 
 * will be null if still in the incident
 * <br> alert (read-only)	The id of the alert this triggered on
 * <br> message_uri (read-only)	The URI of the saved email message that was generated 
